...
export default function Home() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        :root{--fx-ink:#07132c;--fx-green:#315df5;--fx-lime:#a9c2ff;--fx-paper:#f7f9ff;--fx-sand:#eaf0ff;--fx-coral:#6253f1}
        ...
        #home h1{color:#fff!important;letter-spacing:-.078em!important;line-height:.96!important}#home h1 span,#home h1 em{color:var(--fx-lime)!important;font-family:Georgia,serif;font-style:italic}#home p{color:#c7d5d0!important}#home .bg-\\[\\#315df5\\]{background:var(--fx-green)!important;color:#fff!important;border-radius:0!important}
        #trusted-businesses{background:#e9efff!important;border-color:transparent!important}#trusted-businesses *{color:var(--fx-ink)!important}#trusted-businesses .bg-white{background:transparent!important}
        ...
        #services .bg-white,#services .bg-\\[\\#f8f9fb\\]{background:var(--fx-paper)!important}#services .group{border-color:rgba(7,19,44,.14)!important;border-radius:0!important}#services .group:hover{background:#e9efff!important;box-shadow:none!important;transform:translateY(-5px)!important}
        #industries .bg-white{background:var(--fx-paper)!important;border-color:rgba(7,19,44,.14)!important}#industries .bg-white:hover{background:#e9efff!important}#about .bg-\\[\\#fafbfc\\]{background:#edf2ff!important;border-color:rgba(7,19,44,.14)!important}
