...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* WebFX-inspired visual skin — all existing content and behavior remain unchanged. */}
      <style jsx global>{`
        :root{--fx-ink:#10251f;--fx-green:#0a604e;--fx-lime:#d9ff4a;--fx-paper:#f7f5ef;--fx-sand:#ebe8df;--fx-coral:#ff725d}
        html{scroll-behavior:smooth} body{background:var(--fx-paper);color:var(--fx-ink)}
        header{background:rgba(247,245,239,.95)!important;border-color:rgba(16,37,31,.14)!important} header>div:first-child,footer,#geo-checker,#process{background:var(--fx-ink)!important}
        .text-\\[\\#315df5\\]{color:var(--fx-green)!important}.bg-\\[\\#315df5\\]{background-color:var(--fx-green)!important}.hover\\:bg-\\[\\#2449d6\\]:hover{background:#073d31!important}
        #home{background:var(--fx-ink)!important;border-color:rgba(217,255,74,.22)!important}#home:after{content:'';position:absolute;width:900px;height:900px;border:1px solid rgba(217,255,74,.25);border-radius:50%;right:-370px;top:-340px;pointer-events:none}
        #home h1{color:#fff!important;letter-spacing:-.078em!important;line-height:.96!important}#home h1 span,#home h1 em{color:var(--fx-lime)!important;font-family:Georgia,serif;font-style:italic}#home p{color:#c7d5d0!important}#home .bg-\\[\\#315df5\\]{background:var(--fx-lime)!important;color:var(--fx-ink)!important;border-radius:0!important}
        #trusted-businesses{background:var(--fx-lime)!important;border-color:transparent!important}#trusted-businesses *{color:var(--fx-ink)!important}#trusted-businesses .bg-white{background:transparent!important}
        #growth-dashboard,#industries,#case-studies,#contact{background:var(--fx-sand)!important}#pricing,#services,#about,#testimonials{background:var(--fx-paper)!important}
        #growth-dashboard h2,#pricing h2,#services h2,#industries h2,#about h2,#case-studies h2,#process h2,#testimonials h2,#contact h2{letter-spacing:-.075em!important}#growth-dashboard h2 span,#pricing h2 span,#services h2 span,#industries h2 span,#about h2 span,#case-studies h2 span,#testimonials h2 span,#contact h2 span{font-family:Georgia,serif;font-style:italic;color:var(--fx-green)!important}
        #pricing .bg-white,#case-studies .bg-white,#testimonials .bg-white{background:var(--fx-paper)!important;border-color:rgba(16,37,31,.14)!important;border-radius:0!important;box-shadow:none!important}#pricing .border-\\[\\#315df5\\]{border-color:var(--fx-green)!important}#pricing .bg-\\[\\#315df5\\]{background:var(--fx-green)!important}
        #services .bg-white,#services .bg-\\[\\#f8f9fb\\]{background:var(--fx-paper)!important}#services .group{border-color:rgba(16,37,31,.14)!important;border-radius:0!important}#services .group:hover{background:var(--fx-lime)!important;box-shadow:none!important;transform:translateY(-5px)!important}
        #industries .bg-white{background:var(--fx-paper)!important;border-color:rgba(16,37,31,.14)!important}#industries .bg-white:hover{background:var(--fx-lime)!important}#about .bg-\\[\\#fafbfc\\]{background:#e7eee9!important;border-color:rgba(16,37,31,.14)!important}
        #case-studies .bg-\\[\\#315df5\\]{background:var(--fx-coral)!important}#geo-checker .from-\\[\\#315df5\\],#geo-checker .to-\\[\\#7048f6\\]{--tw-gradient-from:var(--fx-lime)!important;--tw-gradient-to:var(--fx-lime)!important}#geo-checker button{color:var(--fx-ink)!important}
        #process .text-\\[\\#7d91ff\\],footer .text-\\[\\#5c7fff\\],footer .text-\\[\\#7d91ff\\]{color:var(--fx-lime)!important}#contact .bg-\\[\\#080d24\\]{background:var(--fx-ink)!important;border-radius:0!important}#contact .bg-\\[\\#315df5\\]{background:var(--fx-lime)!important;color:var(--fx-ink)!important}
        @media(max-width:1023px){#home:after{width:680px;height:680px;right:-420px;top:-290px}}
      `}</style>
