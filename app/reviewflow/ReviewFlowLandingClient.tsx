      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/90 shadow-2xs">
        <div className="max-w-[1680px] w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 h-18 sm:h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/" className="flex items-center group transition" title="Digital FX Home">
              <img
                src="/logo.png"
                alt="Digital FX"
            ...
            <span className="hidden sm:inline-block w-px h-6 bg-slate-200 shrink-0" aria-hidden="true" />
            <div className="inline-flex items-center gap-1.5 bg-blue-50/90 px-2.5 py-1 rounded-lg border border-blue-200/80 shadow-2xs shrink-0">
              <span className="text-[11px] font-black tracking-wider text-[#207de9] uppercase whitespace-nowrap">
                ReviewFlow AI
              </span>
              <span className="text-[9px] font-black bg-[#207de9] text-white px-1.5 py-0.5 rounded uppercase leading-none">
                SaaS
              </span>
            </div>
          </div>

          {/* Quick Nav Links on Desktop (xl:flex with clean spacing so it never squishes) */}
          <nav className="hidden xl:flex items-center gap-6 text-[13px] font-bold text-slate-600 whitespace-nowrap shrink-0">
            <a href="#how-it-works" className="hover:text-[#207de9] transition-colors py-1">
              How It Works
            </a>
            <a href="#simulator" className="hover:text-[#207de9] transition-colors py-1">
              Shop Categories
            </a>
            <a href="#reviews" className="hover:text-[#207de9] transition-colors py-1">
              Owner Reviews
            </a>
            <a href="#pricing" className="hover:text-[#207de9] transition-colors py-1">
              Charges &amp; Standees
            </a>
            <a href="#faqs" className="hover:text-[#207de9] transition-colors py-1">
              FAQs
            </a>
          </nav>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
            <Link
              href="/r/digital-fx"
              target="_blank"
              className="hidden md:inline-flex items-center gap-2 h-10 px-3.5 rounded-xl border border-slate-200 bg-slate-100/90 hover:bg-slate-200 text-xs font-bold text-slate-700 transition-all whitespace-nowrap shrink-0 shadow-2xs"
            >
              <svg
                className="w-4 h-4 text-[#207de9] shrink-0"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 h-10 px-4 sm:px-5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-xs sm:text-sm font-bold text-white shadow-xs transition-all active:scale-95 whitespace-nowrap shrink-0"
            >
              ...
              <svg className="w-3.5 h-3.5 opacity-80 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
