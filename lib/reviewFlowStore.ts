...
const SEED_BUSINESSES: BusinessProfile[] = [
  {
    ...
    ownerName: "Shashank Y",
    phone: "+91 93198 07273",
    email: "contact@digitalfx.in",
    website: "https://www.digitalfx.in",
    address: "Shop No. 210, 2nd Floor, Orbit Plaza, Crossings Republik",
    city: "Ghaziabad",
    state: "Uttar Pradesh",
    pincode: "201016",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJr8q_Orbit_Plaza_DigitalFX",
    logoUrl: "/logo.png",
    brandColor: "#207de9",
    status: "active",
    active: true,
    ...
    totalVisits: 118,
    totalDrafts: 89,
    totalGoogleClicks: 74,
    createdAt: "2026-09-01T10:00:00.000Z",
    updatedAt: "2026-09-26T18:00:00.000Z",
  },
  {
    id: "sharma-dental-clinic",
    qrId: "rf_sharma_dental",
    name: "Dr. Sharma Dental & Implant Clinic",
    category: "Clinic",
    ownerName: "Dr. Rohit Sharma",
    phone: "+91 98112 34567",
    email: "care@sharmadental.in",
    address: "Plot 42, Sector 18, Commercial Market",
    city: "Noida",
    state: "Uttar Pradesh",
    pincode: "201301",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJsharma_dental_noida",
    brandColor: "#0284c7",
    status: "active",
    active: true,
    totalScans: 86,
    totalVisits: 74,
    totalDrafts: 58,
    totalGoogleClicks: 49,
    createdAt: "2026-09-10T12:30:00.000Z",
    updatedAt: "2026-09-26T18:00:00.000Z",
  },
  {
    id: "the-spice-route-restaurant",
    qrId: "rf_spice_route",
    name: "The Spice Route Fine Dine & Family Restaurant",
    category: "Restaurant",
    ownerName: "Vikram Malhotra",
    phone: "+91 98765 43210",
    email: "dine@spiceroute.in",
    address: "C-12, Vaibhav Khand, Indirapuram",
    city: "Ghaziabad",
    state: "Uttar Pradesh",
    pincode: "201014",
    googleReviewUrl: "https://search.google.com/local/writereview?placeid=ChIJspice_route_indirapuram",
    brandColor: "#e11d48",
    status: "active",
    active: true,
    totalScans: 210,
